...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(!closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/DarkMoonPlayz1/StarByte-Engine/main/gitVersion.txt");
			
			http.onData = function (data:String)
			{
				updateVersion = data.split('\n')[0].trim();
				var curVersion:String = MainMenuState.starbyteEngineVersion.trim();
	...
	function startIntro()
	{
		...
		tySpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image(''));
		add(tySpr);
		tySpr.visible = false;
		...
		wrSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image(''));
		add(wrSpr);
		wrSpr.visible = false;
		...
		dnSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image(''));
		add(dnSpr);
		dnSpr.visible = false;
		...
		coolguys = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image(''));
		add(coolguys);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['StarByte Engine by'], 15);
			// credTextShit.visible = true;
				case 3:
					addMoreText('DarkMoon', 15);
					tySpr.visible = true;
					// credTextShit.text += '\npresent...';
			...
			// credTextShit.screenCenter();
				...
				case 9:
					...
					coolguys.visible = false;
				case 10:
					createCoolText(['An edited of'], -40);
				case 11:
